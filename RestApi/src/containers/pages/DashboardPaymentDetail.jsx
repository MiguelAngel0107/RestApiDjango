...
const DashboardPaymentDetail = ({
  ...
  order == null ? order = {transaction_id:2} : order = order 
        ...
        <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
          ...
          <div className="flex flex-col flex-grow border-r border-gray-200 pt-5 bg-white overflow-y-auto">
            <div className="flex items-center flex-shrink-0 px-4">
              ...
              <Link
                to="/"
                className="inline-flex items-center px-2.5 py-1.5 border border-white shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
